...
checkpoint_path = os.path.join(input_path, 'pretrained/lipsync_expert.pth')
...
def train():
    ...
    try:
        os.system("CUDA_LAUNCH_BLOCKING=1 python3 color_syncnet_train.py --data_root {} --checkpoint_dir {} --checkpoint_path {}".format(training_path,model_path,checkpoint_path))
